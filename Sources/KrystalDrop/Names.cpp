...
const char* CHAR_IMG_NAME[KD_NB_CHAR_IMG]= {
...
const char* CHAR_ANIM_NAME[KD_NB_CHAR]= {
   "chaos",  "darkness",  "fire",  "forest",  "light",
   "snow",   "space",     "time",  "water",   "wind" };

const char* CHAR_NAME[KD_NB_CHAR]= {
   "chaos", "darkness", "fire", "forest", "light",
   "snow",  "space",    "time", "water",  "wind" };

const char* MUSIC_NAME[KD_NB_MUSIC]= {
...
/* supported gems: */
const char* GEM_ANIM_NAME[KD_GEM_NB_KINDS]=
{ "nr", "nb", "ng", "ny" };

const char* CHAR_CLASHSOUND_NAME[KD_SND_NBCLASHSOUND]= {
